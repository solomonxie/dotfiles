...
sudo curl -L https://raw.githubusercontent.com/solomonxie/cdn/master/server/python3-setup.sh | sh >> log_python.txt 2>&1

# Setup Shadowsocks
echo "--------------------[   DOWNLOADING BASH SCRIPT FOR SETTING UP SHADOWSOCKS   ]--------------------"
sudo curl -L https://raw.githubusercontent.com/solomonxie/cdn/master/server/shadowsocks/shadowsocks-setup.sh | sh >> log_shadowsocks.txt 2>&1

# Setup ZSH
echo "--------------------[   DOWNLOADING BASH SCRIPT FOR SETTING UP ZSH   ]--------------------"
sudo curl -L https://raw.githubusercontent.com/solomonxie/cdn/master/server/zsh/zsh-setup.sh | sh >> log_zsh.txt 2>&1

# Setup Vim
echo "--------------------[   DOWNLOADING BASH SCRIPT FOR SETTING UP VIM   ]--------------------"
sudo curl -L https://raw.githubusercontent.com/solomonxie/cdn/master/server/vim/vim-setup.sh | sh >> log_vim.txt 2>&1

# Setup Tmux
echo "--------------------[   DOWNLOADING BASH SCRIPT FOR SETTING UP TMUX   ]--------------------"
sudo curl -L https://raw.githubusercontent.com/solomonxie/cdn/master/server/tmux/tmux-setup.sh | sh >> log_tmux.txt 2>&1



# Install Useful Programs
echo "--------------------[   DOWNLOADING BASH SCRIPT FOR Installing common programs   ]--------------------"
sudo curl -L https://raw.githubusercontent.com/solomonxie/cdn/master/server/common-programs.sh | sh >> log_common.txt 2>&1
