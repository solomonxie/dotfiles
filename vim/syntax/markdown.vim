...
" MOD:	Solomon Xie
" URL:		https://github.com/plasticboy/vim-markdown/blob/master/syntax/markdown.vim
...
execute 'syn region mkdStrike matchgroup=htmlStrike start=/\(\([^\\]\|^\)\\\)\@<!\~\~/  end=/\(\([^\\]\|^\)\\\)\@<!\~\~/'               . s:concealcode
