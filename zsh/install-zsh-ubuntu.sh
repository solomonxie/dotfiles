...
wget https://github.com/solomonxie/dotfiles/raw/master/zsh/zshrc-ubuntu -O ~/.zshrc
wget https://github.com/solomonxie/dotfiles/raw/master/zsh/zshrc.extension-ubuntu -O ~/.zshrc.extension
