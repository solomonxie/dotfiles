...
wget https://github.com/solomonxie/cdn/raw/master/zsh/zshrc-rpi -O ~/.zshrc >> ~/.init/log_zsh.txt 1>&2
wget https://github.com/solomonxie/cdn/raw/master/zsh/zshrc.extension-rpi -O ~/.zshrc.extension >> ~/.init/log_zsh.txt 1>&2
...
git clone https://github.com/zsh-users/zsh-syntax-highlighting.git $ZSH_CUSTOM/plugins/zsh-syntax-highlighting >> ~/.init/log_zsh.txt 1>&2
git clone https://github.com/zsh-users/zsh-autosuggestions $ZSH_CUSTOM/plugins/zsh-autosuggestions >> ~/.init/log_zsh.txt 1>&2
