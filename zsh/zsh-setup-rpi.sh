...
wget https://github.com/solomonxie/cdn/raw/master/zsh/zshrc-rpi -O ~/.zshrc >> log_zsh.txt 2>&1
wget https://github.com/solomonxie/cdn/raw/master/zsh/zshrc.extension-rpi -O ~/.zshrc.extension >> log_zsh.txt 2>&1
